...
public class ModelTest extends TestCase{
	...
	public void testRegister(){
		...
		Response response = new Model().registerUser( "Username303", "Password", "Email@Email.com" );
	...
	public void testGetProjects(){
		Model model = new Model();
		String value = "ProjectResponse{projects=[Project{description='Description', name='Project', projectID='57c4da6c1bbd16030013dfc3', usersOnProject=[username303]}]} Response{message='Success'}";
		assertTrue( "Success".equals( model.login( "Username303", "Password" ).getMessage() ) );
	...
	public void testGetProject(){
		...
		String value = "ProjectResponse{projects=[Project{description='Description', name='Project', projectID='57c4da6c1bbd16030013dfc3', usersOnProject=[username303]}]} Response{message='Success'}";
		assertTrue( "Success".equals( model.login( "Username303", "Password" ).getMessage() ) );
		ProjectResponse response = model.getProject( "57c4da6c1bbd16030013dfc3" );
